public class ComplexoDaPenha implements Exercito{

    public String ir(Visitor visitor) {
        return visitor.irComplexoDaPenha(this);
    }
    ...
    public ComplexoDaPenha(String dataOcup, int totalSoldados, int unidAerea, int carrosChoque, String tipoArmamento) {
